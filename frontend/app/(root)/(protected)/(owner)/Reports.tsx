    ...
    <ScrollView>
      <View className="flex-1  p-4">
        ...
        <View className="mt-6">
          ...
          <View className="mt-4 p-4 rounded-2xl border border-orange-500 bg-white gap-4">
            {/* Title */}
            <View className="flex-row items-center gap-2">
              <View className="bg-orange-100 p-2 rounded-xl">
                <Ionicons name="download-outline" size={20} color="#f97316" />
              </View>
              <Text className="font-bold text-lg">Export Reports</Text>
            </View>

            <View className="flex-row justify-between">
              {/* PDF */}
              <TouchableOpacity className="flex-row items-center gap-2 border border-orange-400 rounded-xl px-4 py-3 w-[48%] bg-orange-50">
                <MaterialIcons
                  name="picture-as-pdf"
                  size={22}
                  color="#ef4444"
                />
                <Text className="font-semibold">PDF Format</Text>
              </TouchableOpacity>

              <TouchableOpacity className="flex-row items-center gap-2 border border-orange-400 rounded-xl px-4 py-3 w-[48%] bg-orange-50">
                <MaterialIcons name="table-chart" size={22} color="#16a34a" />
                <Text className="font-semibold">Excel Format</Text>
              </TouchableOpacity>
            </View>

            <TouchableOpacity className="flex-row items-center justify-center gap-2 bg-orange-600 rounded-xl py-3">
